...
@dataclass
class GaudiStableXLDiffusionPipelineOutput(BaseOutput):
...
class GaudiStableDiffusionXLPipeline(
    ...
    def _split_inputs_into_batches(cls, batch_size, latents, prompt_embeds, negative_prompt_embeds,
        ...
        logger.info(
            ...
            f"latent {latents.shape}, prompt_embeds {prompt_embeds.shape}\n"
            f"negative_prompt_embeds  {negative_prompt_embeds.shape}, negative_pooled_prompt_embeds {negative_pooled_prompt_embeds.shape}."
        ...
        if latents_batches[-1].shape[0] < batch_size:
            ...
            logger.info(
                f"num_dummy_samples  {num_dummy_samples}"
            )
            # Pad latents_batches
            ...
            if negative_prompt_embeds is not None:
                ...
                # Pad negative_pooled_prompt_embeds_batches
        ...
        return latents_batches, prompt_embeds_batches, add_text_embeds_batches, num_dummy_samples
    ...
    def __call__(
        ...
        **kwargs,
        ...
        with torch.autocast(device_type="hpu", dtype=torch.bfloat16, enabled=self.gaudi_config.use_torch_autocast):
            ...
            latents_batches, text_embeddings_batches, add_text_embeds_batches, num_dummy_samples = self._split_inputs_into_batches(
                batch_size,
                latents,
                prompt_embeds,
                negative_prompt_embeds,
            ...
            for j in self.progress_bar(range(num_batches)):
                ...
                for i in range(num_inference_steps):
                    ...
                    added_cond_kwargs = {"text_embeds": add_text_embeds_batch, "time_ids": add_time_ids}
                    ...
                    # TODO: Why do we omit t from scheduler step?
        ...
        return GaudiStableXLDiffusionPipelineOutput(
            images=image,
    ...
    def capture_replay(self, latent_model_input, timestep, encoder_hidden_states, timestep_cond,
        ...
        inputs = [latent_model_input, timestep, encoder_hidden_states, timestep_cond,
                  cross_attention_kwargs, added_cond_kwargs, False]
